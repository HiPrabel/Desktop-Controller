...
open_controller_button = tk.Button(welcome_window, text="Start Controller", command=open_controller, font=("Helvetica",14, "bold"), fg=neon_fg, bg=neon_bg, relief=tk.FLAT)
